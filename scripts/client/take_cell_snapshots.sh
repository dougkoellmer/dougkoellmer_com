...
do
	...
	do
		...
		then
			...
			$SNAPSHOT_TOOL --javascript-delay 2500 --quality $IMG_QUALITY --crop-x $CROP_OFFSET --crop-y $CROP_OFFSET --disable-smart-width --width $IMG_SIZE --height $IMG_SIZE $URL $OUT_IMG
		fi
