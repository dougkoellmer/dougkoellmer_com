...
public class List_LifeHacks
{
	public static final String[] LIST =
	{
		...
		"T-shirt Pillowcase",
			"Pillowcase dirty? Grab a t-shirt, put it on there instead. Bam, you're a slob. You can even wear the same shirt the next day.",
		"Bucket of Sand",
		...
		"Hot Mug",
			"Fill a ceramic mug with hot water. Even microwave it afterwards. Pour water out, pour coffee in. Coffee will stay hotter longer. Magic."
	};
}
